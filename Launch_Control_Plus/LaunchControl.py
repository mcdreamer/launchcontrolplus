...
from ParameterShowClient import ParameterShowClient
...
class LaunchControl(ControlSurface):
    ...
    def _init_device(self):
        ...
        # self._parameter_show_client = ParameterShowClient()
        # self._parameter_show_client.setup(self._device_bank_registry)
